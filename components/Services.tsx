        ...
        <div className="relative mx-auto">
          ...
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex">
                ...
                <div key="01" className="flex-[0_0_100%] flex items-center justify-center py-[200px] bg-[#3d204e]">
                  <div className="group p-6 transition-all duration-300 h-full w-full flex items-center justify-center">
                    <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ''}/b1.jpg`} alt="Webdesign" className="absolute top-0 left-[52%]" />
                    <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ''}/b2.jpg`} alt="Webdesign" className="absolute bottom-0 right-[52%]" />
                    <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ''}/webdesign.png`} alt="Webdesign" className="w-[600px] relative z-10" />
                  </div>
                </div>
                
                <div key="02" className="flex-[0_0_100%] flex items-center justify-center bg-[#3d204e]">
                  <div className="flex items-center justify-center flex-col p-6 transition-all duration-300 h-full w-full" style={{ background: `url(${process.env.NEXT_PUBLIC_BASE_PATH || ''}/final-slide-3.jpg) no-repeat center center; background-size: cover;` }}>
                    <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ''}/think.png`} alt="Webdesign" />     
                    <p className="text-white text-2xl font-bold my-12">Be unique and make sure your website stands for the crowd.</p>  
                    <div className="cta-box flex gap-4">
                      <Button className="btn-primary border-2 border-white rounded-none px-12 py-6 text-lg font-normal">Contact Us</Button>
                      <Button className="btn-primary border-2 border-white rounded-none px-12 py-6 text-lg font-normal">View Portfolio</Button>
                    </div>
                  </div>
                </div>
                ...
                <div key="02" className="flex-[0_0_100%] flex items-center justify-center bg-[#3d204e]">
                  <div className="flex items-center justify-center flex-col p-6 transition-all duration-300 h-full w-full" style={{ background: `url(${process.env.NEXT_PUBLIC_BASE_PATH || ''}/burst.jpg) no-repeat center center; background-size: cover;` }}>                    
                    <h3 className="text-[96px] text-white font-pacifico mb-[-20px]">Creativity</h3>
                    <p className="text-[124px] text-white font-bowlby mt-0">UNLEASHED</p>
                    <p className="text-white text-2xl font-bold">Burst your creativity to craft inspired pages.</p>               
                  </div>
                </div>
