  ...
  return (
    <section id="brands" className="py-20 bg-background">
      <div className="text-center mb-16">
        ...
        <h2 className="mb-4 mx-auto font-oswald text-[64px] md:text-[96px] leading-tight portrait:text-[48px]" style={{ textShadow: '5px 5px 5px rgba(0, 0, 0, 0.15)', letterSpacing: '-3px' }}>
          Grandes Marcas
        </h2>
      </div>
        ...
        <div className="overflow-hidden">
          ...
          >
            {brands.map((brand, index) => (
              <div key={`first-${index}`} className="flex-[0_0_auto] w-[220px] mr-8 portrait:w-[180px]">
                ...
                <div className="relative w-full h-full flex items-center justify-center">
                  <img
                    ...
                    className="max-h-[90px] max-w-[200] portrait:max-w-[150px]"
                  />
                </div>
