            ...
            <div className="flex">
                ...
                <div key="01" className="flex-[0_0_100%] flex items-center justify-center bg-[#3d204e] min-h-[800px]">
                  <div className="flex items-center justify-center flex-col p-6 transition-all duration-300 h-full w-full" style={{ background: `url(${process.env.NEXT_PUBLIC_BASE_PATH || ''}/burst.jpg) no-repeat center center; background-size: cover` }}>                    
                    <h3 className="text-[56px] text-white font-pacifico mb-[-50px] portrait:text-[32px]">Sua marca com muito mais</h3>
                    <p className="text-[140px] text-white font-oswald mt-0 font-bold tracking-tight leading-tight portrait:text-[75px]" style={{ textShadow: '5px 5px 5px rgba(0, 0, 0, 0.15)', letterSpacing: '-3px' }}>IMPACTO</p>
                    <p className="text-white text-3xl font-normal portrait:text-xl">Sua marca na internet com o melhor custo-benefício</p>               
                  </div>
                </div>           
                ...
                <div key="02" className="flex-[0_0_100%] flex items-center justify-center bg-[#3d204e] min-h-[800px]">
                  <div className="flex items-center justify-center flex-col p-6 transition-all duration-300 h-full w-full" style={{ background: `url(${process.env.NEXT_PUBLIC_BASE_PATH || ''}/fullscreen-slide-1.jpg) no-repeat center center; background-size: cover` }}>
                        ...
                        <h3 className="text-[56px] text-neongreen font-pacifico mb-[-40px] portrait:text-[32px]">Mais cliques, mais</h3>
                        <p className="text-[140px] text-white font-oswald mt-0 font-bold tracking-tight leading-tight portrait:text-[75px]" style={{ textShadow: '5px 5px 5px rgba(0, 0, 0, 0.15)', letterSpacing: '-3px' }}>VENDAS</p>
                        <p className="text-white text-3xl font-normal portrait:text-xl">Atraia clientes qualificados com um site feito para converter</p>  
                        {/* CTA WhatsApp */}
                        <div className="flex justify-center gap-8 w-full max-w-[700px] mx-auto mt-10 portrait:flex-col portrait:gap-4 portrait:w-full">
                ...
                <div key="03" className="flex-[0_0_100%] flex items-center justify-center bg-[#3d204e] min-h-[800px]">
                  <div className="flex items-center justify-center flex-col p-6 transition-all duration-300 h-full w-full" style={{ background: `url(${process.env.NEXT_PUBLIC_BASE_PATH || ''}/background1.jpg) no-repeat center center; background-size: cover` }}>                    
                    <h3 className="text-[56px] text-white font-pacifico mb-[-40px] portrait:text-[32px]">Investimento em</h3>
                    <p className="text-[140px] text-white font-oswald mt-0 font-bold tracking-tight leading-tight portrait:text-[75px]" style={{ textShadow: '5px 5px 5px rgba(0, 0, 0, 0.15)', letterSpacing: '-3px' }}>DESIGN PREMIUM</p>
                    <p className="text-white text-3xl font-normal portrait:text-xl">Aumente a percepção de valor do seu produto</p>
                  </div>
                </div>
